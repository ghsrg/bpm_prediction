...
1. `preserve` is the default topology mode.
2. `collapse_for_prediction` is supported by `DynamicGraphBuilder`.
3. Existing tests cover selected collapsed-mask behavior.

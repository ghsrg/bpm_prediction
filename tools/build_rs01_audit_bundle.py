...
def build_bundle(*, audit_root: Path, raw_metrics_dir: Path, registry: Path) -> None:
    ...
    _write_csv(audit_root / "outcome_partition.csv", ["run_id", "historical_run_id", "paper_model", "metric_contract_id", "seed", *OUTCOME_METRICS], outcome_rows)
    _write_csv(audit_root / "endpoint_error_profile.csv", ["run_id", "historical_run_id", "paper_model", "metric_contract_id", "seed", "metric", "value"], profile_rows)

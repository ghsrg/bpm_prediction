...
Updated: 2026-03-17  
Status: ACTIVE (Stage 3.2 completed, Stage 4 preparation)
...
MVP2.5 keeps MVP1 training compatibility while Stage 3.2 BPMN ingestion is already integrated and Stage 4 Neo4j backend is next.

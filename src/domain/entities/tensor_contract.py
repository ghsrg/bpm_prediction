...
class GraphTensorContract(TypedDict):
    ...
    target_label: NotRequired[str | None]
    target_labels: NotRequired[list[str] | None]
    candidate_ids: NotRequired[tuple[str, ...] | list[str] | None]
    candidate_labels: NotRequired[tuple[str, ...] | list[str] | None]
    candidate_class_index: NotRequired[torch.LongTensor | None]
    candidate_is_unseen: NotRequired[torch.BoolTensor | None]
    struct_node_to_candidate_index: NotRequired[torch.LongTensor | None]
    candidate_allowed_target_mask: NotRequired[torch.BoolTensor | None]

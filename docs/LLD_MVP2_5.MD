...
3. If no eligible snapshot exists for prefix timestamp, strict_asof can still consume base payload; temporal no-leak enforcement remains open technical debt.

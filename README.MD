...
7. `on_missing_asof_snapshot`: `disable_stats | use_base | raise` (default: `disable_stats`)
...
5. Set `on_missing_asof_snapshot=disable_stats` for no-leak temporal experiments.
